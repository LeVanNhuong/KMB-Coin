...
namespace KMB_Coin.Models
{
    public class Constants
    {
        ...
        public static string APP_NANE { get { return Environment.GetEnvironmentVariable("APP_NANE") ?? "KMB_Coin"; } } //throw new KeyNotFoundException("Environment variable `APP_NANE` not found."); } }
        ...
        public static DateTime JS_TIMESTAMP { get { return new DateTime(2009, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc); } }
